<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="TiposVer.aspx.cs" Inherits="GesTienda.TiposVer1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="InfoContenido" runat="server">
 ...
 <asp:Label ID="lblMensajes" ForeColor="red" runat="server"></asp:Label>
    ...
    <asp:GridView ID="grpTipos" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="IdTipo" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Width="50%" PageSize="5">
