    ...
    public partial class Ejercicio1 : System.Web.UI.Page
    {
        ...
        protected void btnObtenerInformacion_Click(object sender, EventArgs e)
        {
            try 
            {
                ...
                var resultado = ws.wstitulosuni("C", StrCursoAcademico); ws.Close();
                ...
                { 
                    ...
                    StrTabla += "<div style='display:table-cell;'>" + "<a href='" + item.url + "'>Más información</a></div>";
                    StrTabla += "</div>"; 
                }
                StrTabla += "</div>";
            ...
            catch (Exception ex)
            {
                ...
                lblResultado.Text = "Información de " + txtCurso.Text.ToUpper() + " no disponible <br />" + StrError; GridView1.Dispose(); 
                GridView1.DataBind();
            }
        }
    }
